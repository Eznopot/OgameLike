 ...
 */
final class Version20220110171154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ongoing_atk (id INT AUTO_INCREMENT NOT NULL, planets_id INT NOT NULL, start DATETIME NOT NULL, difficuly INT NOT NULL, end_time DATETIME NOT NULL, success_rate INT NOT NULL, units_atk INT DEFAULT NULL, INDEX IDX_1AC6CF2BDCBDC375 (planets_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
