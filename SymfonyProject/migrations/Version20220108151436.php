 ...
 */
final class Version20220108151436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ongoing_atk (id INT AUTO_INCREMENT NOT NULL, planet_id_id INT NOT NULL, start INT NOT NULL, difficuly INT NOT NULL, number_of_units INT NOT NULL, time_of_atk INT NOT NULL, UNIQUE INDEX UNIQ_1AC6CF2B6B47FF93 (planet_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
