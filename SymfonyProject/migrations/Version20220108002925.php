 ...
 */
final class Version20220108002925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE batiments ADD upgrade_time INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE batiments DROP upgrade_time');
    }
}
