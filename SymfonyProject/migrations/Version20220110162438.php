 ...
 */
final class Version20220110162438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ongoing_atk (id INT AUTO_INCREMENT NOT NULL, start DATETIME NOT NULL, difficuly INT NOT NULL, end_time DATETIME NOT NULL, success_rate INT NOT NULL, units_atk INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE planets_ongoing_atk (planets_id INT NOT NULL, ongoing_atk_id INT NOT NULL, INDEX IDX_E9E52A4DCBDC375 (planets_id), INDEX IDX_E9E52A46C3CC02F (ongoing_atk_id), PRIMARY KEY(planets_id, ongoing_atk_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE planets_ongoing_atk ADD CONSTRAINT FK_E9E52A4DCBDC375 FOREIGN KEY (planets_id) REFERENCES planets (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE planets_ongoing_atk ADD CONSTRAINT FK_E9E52A46C3CC02F FOREIGN KEY (ongoing_atk_id) REFERENCES ongoing_atk (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planets_ongoing_atk DROP FOREIGN KEY FK_E9E52A46C3CC02F');
        $this->addSql('ALTER TABLE planets_ongoing_atk DROP FOREIGN KEY FK_E9E52A4DCBDC375');
        ...
        $this->addSql('DROP TABLE planets_ongoing_atk');
